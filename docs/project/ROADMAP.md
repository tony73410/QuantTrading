...
- P27结果不能单独成为反转阈值，P28也没有默认倍数。P30测试值不是默认值或AAPL投资建议；P40的同值新结果同样不是默认值或投资建议。额外P31/P33/P35来源、数值Risk组合、P23-5模拟及任何Accounting/Paper/Live仍需分别批准。当前没有下一项已批准开发或验证工作。
