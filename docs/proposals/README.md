...
Current status (2026-08-14): main commit `a8f00c5` remains the published baseline. Approved `PROPOSAL-037` is implemented and verified disabled in the current uncommitted worktree: a separate Asset-State-owned mathematical-cycle stream can promote explicit exact cumulative P28 evidence without changing the manual ledger, P35 control or P29–P35 consumers. Central SQLite is v22/137 with seven empty P37 tables and no real-symbol stream. P23-4C2 daily-opportunity counting remains pending.
