...
Subsequent approved extension: PROPOSAL-025 implements only the bounded P23-1E-A manual latest-session runner. It preserves R1 v1.0.0 and adds immutable R1 v1.1.0 with inclusive latest-completed-session windows; it reuses this proposal's mathematics, Schema v14 and inspector. Full P23-1E comparison/scoring and all financial consumers remain excluded.
