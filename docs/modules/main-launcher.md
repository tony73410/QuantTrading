...
P23-1 Spectral Volatility Research and its PROPOSAL-025 manual latest-session controls remain a subtab inside the existing Single-Asset Factor owner page. No standalone application or Launcher shortcut is added; the existing Factor and Run History entries remain the trusted navigation paths.
