...
- P23-1 manual preview and inspection remain in the existing Factor-page subtab and add no Launcher entry. One explicit click can dispatch only the injected P23-1E-A runner; the panel still contains no calculation, Provider or SQL implementation. Full P23-1E comparison/scoring and every State/Target/Decision/Risk/Backtesting/Execution consumer remain unimplemented.
