...
Approved PROPOSAL-034 active-data inspection reloaded all three exact AAPL P31 sources, three P33 attempts and three accepted manual-review results. Selecting a result rendered its three locked rules and enabled the four exact P33/P31/P29/P28 Run paths; this read-only check wrote no database row.
